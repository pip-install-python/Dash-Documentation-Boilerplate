...
ICONS: Dict[str, str] = {
    ...
    "https://emojimart.2plot.dev": "mdi:web",
    "https://email.2plot.dev": "mdi:web",
    "https://modelviewer.2plot.dev": "mdi:web",
    "https://excalidraw.2plot.dev": "mdi:web",
    "https://piratesbargain.com": "mdi:sail-boat",
    "https://ai-agent.buzz": "game-icons:beehive",
    "https://2plot.media": "mdi:filmstrip",
